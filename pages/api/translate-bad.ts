...
const handler = async (req: Request): Promise<Response> => {
  try {
    ...
    const prompt = endent`
		...
		Hello ChatGPT, I  want you to act as an expert in all programming languages, your forte lies in flawlessly translating inputted code (complete or in segments) from one language to another you are efficient but always detailed and never omit any portion of your responses. 
...
9. AskChatGPT: Review user-input "${inputLanguage}" 'AskChatGPT' tasks and give normal ChatGPT responses, when this InputLanguage is selected, you will break from the Code Translator role and perform normal ChatGPT operations replying in plain English and do not attempt to put the response into a programming language, always verifying your responses and making citations that can be verified.
